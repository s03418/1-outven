...
@Service
public class ModifyMail implements MailServiceInter {
    ...
    public String sendSimpleMessage(String to) throws MessagingException {
        ...
        message.setSubject("회원정보 이메일 변경 인증"); // 제목
        ...
        content += "<h3 style='color:blue;'>회원정보 이메일 변경에 필요한 인증 코드입니다.</h3>";
    ...
    public MimeMessage createMessage(String to) throws MessagingException, UnsupportedEncodingException {
        ...
        message.setSubject("아웃벤 회원정보 이메일변경 인증 인증번호 입니다.");
