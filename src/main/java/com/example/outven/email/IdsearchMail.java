...
@Service
public class IdsearchMail implements MailServiceInter {
    ...
    public String sendSimpleMessage(String to) throws MessagingException {
        ...
        message.setSubject("ID찾기 이메일 인증"); // 제목
        ...
        content += "<br>";
        content += "<p>아래 코드를 아이디 찾기 창으로 돌아가 입력해주세요<p>";
        content += "<br>";
        content += "<p>항상 감사합니다!<p>";
        content += "<br>";
        content += "<div align='center' style='border:1px solid black; font-family:verdana';>";
        content += "<h3 style='color:blue;'>아이디 찾기에 필요한 인증 코드입니다.</h3>";
    ...
    public MimeMessage createMessage(String to) throws MessagingException, UnsupportedEncodingException {
        ...
        message.setSubject("아웃벤 ID찾기 인증번호 입니다.");
